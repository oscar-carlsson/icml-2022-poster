...
\institute{\textbf{1}: Department of Mathematical Sciences, Chalmers University of Technology, Sweden, \textbf{2}: Machine Learning Group at Berlin Institute of Technology, Germany, \textbf{3}: Berlin Institute for the Foundations of Learning and Data, Germany, \textbf{4}: Department of Physics, University of Gothenburg, Sweden \textbf{5}: Department of Mathematics and Mathematical Statistics, Umeå~University, Sweden, \textbf{6}: Zenseact, Gothenburg, Sweden}
    ...
    \begin{frame}[t]
        \begin{columns}[t]
            ...
            \begin{column}{\twocolwid}
                ...
                \begin{alertblock}{\huge\raisebox{5pt}{Research question}}
                ...
                \end{alertblock}
                \medskip
                \begin{alertblock}{\huge\raisebox{5pt}{Key takeaway}}
                    \centering
